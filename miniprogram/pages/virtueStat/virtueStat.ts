...
import {getVirtueStat} from "../../api/virtue";
...
Page({
  data: {
    ...
    // 图例和环形图数据
    chartData: [
      { name: '友好亲和', count: 0, percentage: 0, color: '#fdd835', percentageColor: '#fdd835' }, // 鲜黄
      { name: '勇于承担', count: 0, percentage: 0, color: '#ffb3ba' }, // 浅粉
      { name: '善待他人', count: 0, percentage: 0, color: '#81c784' }, // 浅绿
      { name: '帮助给予', count: 0, percentage: 0, color: '#e0cda7' }, // 浅棕
      { name: '感恩之心', count: 0, percentage: 0, color: '#9575cd' },   // 浅紫
      { name: '勤学不辍', count: 0, percentage: 0, color: '#fc5549' },   // 浅红
      { name: '值得信赖', count: 0, percentage: 0, color: '#99e5ff' }   // 浅蓝
    ],
  },
